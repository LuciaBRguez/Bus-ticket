...
<body>
	...
	<form:form modelAttribute="buscarViajesIdaVuelta" style="text-align: center;">
	<div id="imprimir">
		<table style="margin:auto;">
			...
			<c:forEach items="${viajeidalist}" var="viaje">
				<tr>
		...
		<br>
		<table style="margin:auto;">
			<caption><b><spring:message code="vuelta"/></b></caption>
			<tr>
				<td><b><spring:message code="origen"/></b></td>
				<td><b>&emsp;<spring:message code="fecha_ida_tit"/></b></td>
				<td><b>&emsp;<spring:message code="hora_salida"/></b></td>
			...
			<c:forEach items="${viajevueltalist}" var="viaje">
				<tr>
					<td><c:out value="${viaje.origen}"></c:out></td>
					<td>&emsp;<c:out value="${viaje.fecha_salida}"></c:out></td>
					<td>&emsp;<c:out value="${viaje.hora_salida}"></c:out></td>
					<td>&emsp;<c:out value="${viaje.destino}"></c:out></td>
					<td>&emsp;<c:out value="${viaje.plazas_libres}"></c:out></td>
					<td>&emsp;<form:radiobutton path="id_vuelta" value="${viaje.id}" checked="checked"/></td>
				</tr>
			</c:forEach>
		</table>
		<br>
		</div>
		<button type="submit" value="buscarViajesIdaVuelta"><spring:message code="siguiente"/></button>
